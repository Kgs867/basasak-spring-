    ...
    <article class="entry">
     <div class="entry-content-container">
      <div class="entry-meta">
       ...
       <div>
        <i class="fa fa-calendar"></i>${article.r_date}
       </div>
      </div>
      <!-- End .entry-meta -->

      <div class="entry-content-wrapper">
       <h2 class="entry-title">${article.r_title}</h2><hr> 
     ...
     <div class="ipbnt">
     <input type="button" value="추천" id="recommend" class="btn-two green rounded">
     <input type="button" name="r_recommend" id="r_recommend" class="btn-check">
      &nbsp;&nbsp;&nbsp;&nbsp; 
     <input type="button" value="글수정" class="btn-two green rounded"
       onclick="document.location.href='updateForm.do?r_num=${article.r_num}&pageNum=${pageNum}'">
      &nbsp;&nbsp;&nbsp;&nbsp; 
     <input type="button" value="글삭제" class="btn-two green rounded"
       onclick="document.location.href='deleteForm.do?r_num=${article.r_num}&pageNum=${pageNum}'">
      &nbsp;&nbsp;&nbsp;&nbsp; 
     <input type="button" value="글목록" class="btn-two green rounded"
