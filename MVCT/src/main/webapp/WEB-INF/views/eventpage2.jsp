				...
				<div class="row flex-shop">
					...
					<div class="col-md-9 ">
						...
						<div class="products-container max-col-3">
							<div class="row">
								<img src="resources/assets/images/blog/이벤트페이지2.png" alt="이벤트페이지1" style="outline:none;">
