		...
		<div class="main">
			<div class="page-header2 largest parallax custom text-center"
				...
				<div class="container-fluid">
					<h1 class="hcolor">MEMBERSHIP</h1>
					<h8>EVENT 각종 헤택을 만나보세요.</h8>
				...
				<div class="row flex-shop">
							...
							<div class="filter-group-widget">
								<div class="panel-group" role="tablist"
									...
									<div class="snb2 f1">
										...
										<p class="basasak">Basasak</p>										
										<div class="snb-wrap hover-relative">
											<ul style="list-style-type: none;">
												<li class="info-hover-li"><a href="/Project/eventpage1.do">신규가입
														<img class="info-hover-img"
														src="resources/assets/images/blog/신규가입호버.png" alt="비스켓" />
												</a></li>
												
												<li class="info-hover-li2">
												<a href="/Project/eventpage2.do"> 적립금<img
														class="info-hover-img2" src="resources/assets/images/blog/적립금호버.png"
														alt="스낵" />
												</a></li>
												
												<li class="info-hover-li3">
												<a href="/Project/eventpage3.do">배송비무료 
												<img class="info-hover-img3" src="resources/assets/images/blog/배송비무료호버.png"
														alt="초코" />
												</a></li>
												
												<li class="info-hover-li4">
												<a href="/Project/eventpage4.do">리뷰 
												<img class="info-hover-img4" src="resources/assets/images/blog/리뷰호버.png"
														alt="초코" />
												</a></li>
											</ul>
										</div>
					...
					<div class="col-md-9 ">
						...
						<div class="products-container max-col-3">
							<div class="row">
								<img src="resources/assets/images/blog/이벤트페이지4.png" alt="이벤트페이지4" style="outline:none;">
