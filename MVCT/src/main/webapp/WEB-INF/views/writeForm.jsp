                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8 col-sm-6">
                            ...
                            <form method="post" name="writeform" action="writePro.do" onsubmit="return writeSave()"><!-- <form action="#" method="post" id="contact-form"> -->
                            <input type="hidden" name="r_num" value="${r_num}">
                                ...
                                <input type="button" class="btn btn-custom min-width" value="목록보기" OnClick="window.location='review.do'">
                            </form>
                        </div><!-- End .col-md-8 -->
