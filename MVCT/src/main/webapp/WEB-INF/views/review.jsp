				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="table-responsive">
									...
									<c:forEach var="article" items="${articleList}">
										<tr height="30">
											...
											<td align="center" width="50"><c:out
													value="${article.r_num}" /></td>
											<td width="250">
												<!-- 글상세보기 부분  -->
												<a href="content.do?r_num=${article.r_num}&pageNum=${pageNum}">${article.r_title}</a>				
											</td>
											<td align="center" width="100">${article.m_id}</td>
											<td align="center" width="150"><fmt:formatDate value="${article.r_date}" timeStyle="medium" pattern="yyyy-MM-dd" /></td>
							...
							<table class="table table-bordered table-hover table-condensed">
								<tr>
									<td align="right" bgcolor="#fff"><input type="button"
										class="btn btn-custom min-width" value="글쓰기"
