							...
							<table class="table table-bordered table-hover table-condensed">
								...
								<tbody>
									...
									<tr height="30">
										...
										<td width="250">
											<!-- 글상세보기 부분  --> 
											<a href="noticecontent.do?n_num=${article.n_num}&pageNum=${pageNum}">${article.n_title}</a>
										</td>
										<td align="center" width="100">관리자</td>
										<td align="center" width="150"><fmt:formatDate value="${article.n_date}" timeStyle="medium" pattern="yyyy-MM-dd" /></td>
						...
						<table class="table table-bordered table-hover table-condensed">
							<tr>
								<td align="right" bgcolor="#fff">
									<input type="button" class="btn btn-custom min-width" value="글쓰기" OnClick="window.location='writeNoticeForm.do'">
								</td>
							</tr>
						</table>
						<form align="center">
