...
<link rel="stylesheet" href="/MVCT/resources/assets/css/plugins.min.css">
<link rel="stylesheet" href="/MVCT/resources/assets/css/settings.css">
<link rel="stylesheet" href="/MVCT/resources/assets/css/layers.css">
<link rel="stylesheet" href="/MVCT/resources/assets/css/navigation.css">
<link rel="stylesheet" href="/MVCT/resources/assets/css/style.css">

<!-- basasak css 추가 -->
<link rel="stylesheet" href="/MVCT/resources/assets/css/basasak.css">
...
<body>
  ...
  <div class="main">
                <div id="rev_slider_wrapper" class="slider-container rev_slider_wrapper rev_container_1 fullwidthbanner-container" data-alias="classicslider1">
                    <div id="rev_slider" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                        <ul>
                            <!-- SLIDE  -->
                            <li data-index="rs-1" data-transition="slideoverup" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1200"  data-thumb="resources/assets/images/homepages/index/slide1-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Bold">

                                <!-- MAIN IMAGE -->
                                <img src="resources/assets/images/homepages/index/mainslide２.png"  alt="Slider bg 1"  data-bgposition="center center" data-duration="11000" data-ease="Linear.easeNone" class="rev-slidebg" data-no-retina>
                                <!-- LAYERS -->
 ...
 -->
                      ...
                      <!--           <a class="tp-caption btn btn-custom2 min-width tp-resizeme rs-parallaxlevel-0" 
                            ...
                            <!-- SLIDE  -->
                            <li data-index="rs-2" data-transition="slideoverdown" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="1200" data-thumb="resources/assets/images/homepages/index/slide2-100x50.jpg" data-rotate="0" data-saveperformance="off" data-title="Purchase">

                                <!-- MAIN IMAGE -->
                                <img src="resources/assets/images/homepages/index/slide1.png"  alt="Slider bg 2"  data-bgposition="center center" data-duration="11000" data-ease="Linear.easeNone" class="rev-slidebg" data-no-retina>
                                <!-- LAYERS -->
 ...
 -->
                    ...
                    <div class="portfolio-row">
                        ...
                        <div id="portfolio-item-container" class="popup-gallery max-col-4" data-layoutmode="fitRows">
                            <div class="portfolio-item web-design wordpress">
                                <figure>
                                    <img src="resources/assets/images/cookie1.png" alt="Portfolio Name">
                                    <figcaption>
         <a href="resources/assets/images/portfolio/grid/오예스.png"
          data-thumb="resources/assets/images/portfolio/grid/오예스.png"
        ...
        <h3 class="portfolio-title">
         <a href="#" title="Portfolio name">촉촉하고 부드러운 리얼케이크</a>
                            ...
                            <div class="portfolio-item web-design marketing">
                                <figure>
        <img src="resources/assets/images/portfolio/grid/후렌치파이.png"
         alt="Portfolio Name">
        <figcaption>
         <a href="resources/assets/images/portfolio/grid/후렌치파이.png"
          data-thumb="resources/assets/images/portfolio/grid/후렌치파이.png"
          class="zoom-btn"><i class="fa fa-search"></i></a>
         <!--   <a href="http://www.youtube.com/watch?v=jt8YicG-F6c" data-thumb="assets/images/portfolio/grid/item2.jpg" class="zoom-btn"><i class="fa fa-search"></i></a> 동영상 -->
                            ...
                            <div class="portfolio-item wordpress">
                                <figure>
        <img src="resources/assets/images/portfolio/grid/자가비.png"
         alt="Portfolio Name">
        <figcaption>
         <a href="resources/assets/images/portfolio/grid/자가비.png"
          data-thumb="resources/assets/images/portfolio/grid/자가비.png"
          class="zoom-btn"><i class="fa fa-search"></i></a>
        </figcaption>
       </figure>
                                <div class="portfolio-meta">
         ...
         <a href="#">자가비</a>
                            ...
                            <div class="portfolio-item web-design wordpress">
                               <figure>
        <img src="resources/assets/images/portfolio/grid/칼로리바란스.png"
         alt="Portfolio Name">
        <figcaption>
         <a href="resources/assets/images/portfolio/grid/칼로리바란스.png"
          data-thumb="resources/assets/images/portfolio/grid/칼로리바란스.png"
          class="zoom-btn"><i class="fa fa-search"></i></a>
        </figcaption>
       </figure>
                                <div class="portfolio-meta">
        ...
        <div class="portfolio-tags">
         <a href="#">칼로리바란스</a>
                            ...
                            <div class="portfolio-item logo-design video marketing">
                                <figure>
        <img src="resources/assets/images/portfolio/grid/뽀로로와친구들.png"
         alt="Portfolio Name">
        <figcaption>
         <a href="resources/assets/images/portfolio/grid/뽀로로와친구들.png"
          data-thumb="resources/assets/images/portfolio/grid/뽀로로와친구들.png"
          class="zoom-btn"><i class="fa fa-search"></i></a>
        </figcaption>
       </figure>
       <div class="portfolio-meta">
        ...
        <div class="portfolio-tags">
         <a href="#">뽀로로와친구들</a>
                            ...
                            <div class="portfolio-item logo-design wordpress">
                                <figure>
        <img src="resources/assets/images/portfolio/grid/초코파이.png"
         alt="Portfolio Name">
        <figcaption>
         <a href="resources/assets/images/portfolio/grid/초코파이.png"
          data-thumb="resources/assets/images/portfolio/grid/초코파이.png"
          class="zoom-btn"><i class="fa fa-search"></i></a>
        </figcaption>
       </figure>
                                <div class="portfolio-meta">
                                   <h3 class="portfolio-title">
         <a href="#" title="초코파이">새로운 시작, 오리온 초코파이情</a>
        </h3>
        <div class="portfolio-tags">
         <a href="#">오리온 초코파이情</a>
                            ...
                            <div class="portfolio-item video marketing">
                                <figure>
        <img src="resources/assets/images/portfolio/grid/바나나초코파이.png"
         alt="Portfolio Name">
        <figcaption>
         <a href="resources/assets/images/portfolio/grid/바나나초코파이.png"
          data-thumb="resources/assets/images/portfolio/grid/바나나초코파이.png"
          class="zoom-btn"><i class="fa fa-search"></i></a>
        </figcaption>
       </figure>
       <div class="portfolio-meta">
        ...
        <div class="portfolio-tags">
         <a href="#">초코파이情 바나나</a>
                            ...
                            <div class="portfolio-item wordpress">
                                <figure>
        <img src="resources/assets/images/portfolio/grid/카스타드.png"
         alt="Portfolio Name">
        <figcaption>
         <a href="resources/assets/images/portfolio/grid/카스타드.png"
          data-thumb="resources/assets/images/portfolio/grid/카스타드.png"
          class="zoom-btn"><i class="fa fa-search"></i></a>
        </figcaption>
       </figure>
       <div class="portfolio-meta">
        <h3 class="portfolio-title">
         <a href="#" title="카스타드">촉촉해서 더 맛있는 오리온 카스타드</a>
        </h3>
        <div class="portfolio-tags">
         <a href="#">카스타드</a>
                                    </div><!-- End .portfolio-tags -->
    ...
    <div class="container-fluid">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-owner">
                                        ...
                                        <figure>
                                            <img src="resources/assets/images/testimonials/user1.jpg" alt="Name">
                                        </figure>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-owner">
                                        ...
                                        <figure>
                                            <img src="resources/assets/images/testimonials/user2.jpg" alt="Name">
                                        </figure>
                                    </div><!-- End .testimonial-owner -->
                                </div><!-- End .testimonial-box -->
                            </div><!-- End .swiper-slide -->
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-owner">
                                        ...
                                        <figure>
                                            <img src="resources/assets/images/testimonials/user3.jpg" alt="Name">
                                        </figure>
                                    </div><!-- End .testimonial-owner -->
                                </div><!-- End .testimonial-box -->
                            </div><!-- End .swiper-slide -->
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-owner">
                                        ...
                                        <figure>
                                            <img src="resources/assets/images/testimonials/user4.jpg" alt="Name">
                                        </figure>
                                    </div><!-- End .testimonial-owner -->
                                </div><!-- End .testimonial-box -->
                            </div><!-- End .swiper-slide -->
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-owner">
                                        ...
                                        <figure>
                                            <img src="resources/assets/images/testimonials/user5.jpg" alt="Name">
                                        </figure>
                                    </div><!-- End .testimonial-owner -->
                                </div><!-- End .testimonial-box -->
                            </div><!-- End .swiper-slide -->
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box">
                                    ...
                                    <div class="testimonial-owner">
                                        ...
                                        <figure>
                                            <img src="resources/assets/images/testimonials/user6.jpg" alt="Name">
                                        </figure>
                                    </div><!-- End .testimonial-owner -->
                                </div><!-- End .testimonial-box -->
                            </div><!-- End .swiper-slide -->
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <article class="entry entry-grid">
                                    <div class="entry-media">
                                        <figure>
                                            <a href="single.html"><img src="resources/assets/images/blog/post5.jpg" alt="Post image"></a>
                                        </figure>
                                    </div><!-- End .entry-media -->
                            ...
                            <div class="swiper-slide">
                                <article class="entry entry-grid">
                                    <div class="entry-media">
                                        <figure>
                                            <a href="single.html"><img src="resources/assets/images/blog/post6.jpg" alt="Post image"></a>
                                        </figure>
                                    </div><!-- End .entry-media -->
                            ...
                            <div class="swiper-slide">
                                <article class="entry entry-grid">
                                    <div class="entry-media">
                                        <figure>
                                            <a href="single.html"><img src="resources/assets/images/blog/post7.jpg" alt="Post image"></a>
                                        </figure>
                                    </div><!-- End .entry-media -->
        ...
        <!-- REVOLUTION JS FILES -->
        <script type="text/javascript" src="resources/assets/js/jquery.themepunch.tools.min.js"></script>
        ...
        <script type="text/javascript" src="resources/assets/js/extensions/revolution.extension.actions.min.js"></script>
        <script type="text/javascript" src="resources/assets/js/extensions/revolution.extension.carousel.min.js"></script>
        <script type="text/javascript" src="resources/assets/js/extensions/revolution.extension.kenburn.min.js"></script>
        <script type="text/javascript" src="resources/assets/js/extensions/revolution.extension.layeranimation.min.js"></script>
        <script type="text/javascript" src="resources/assets/js/extensions/revolution.extension.migration.min.js"></script>
        <script type="text/javascript" src="resources/assets/js/extensions/revolution.extension.navigation.min.js"></script>
        <script type="text/javascript" src="resources/assets/js/extensions/revolution.extension.parallax.min.js"></script>
        <script type="text/javascript" src="resources/assets/js/extensions/revolution.extension.slideanims.min.js"></script>
        <script type="text/javascript" src="resources/assets/js/extensions/revolution.extension.video.min.js"></script>
                ...
                $(document).ready(function() {
                    ...
                    if($("#rev_slider").revolution == undefined){
                        ...
                        revapi = $("#rev_slider").show().revolution({
                            sliderType:"standard",
                            jsFileLocation:"resources/assets/js/",
                            sliderLayout:"auto",
                            dottedOverlay:"none",
                            delay:10000,
                            navigation: {
